...
task :create_quarters => [:environment] do
  ...
  table.each do |row|
    ...
    if row.first_upload_date >= '2013-07-01'.to_date && row.first_upload_date < '2013-10-01'.to_date # 2013 Q3
      ...
      Person_quarter.create_quarter_record(row.user_id, '2013-07-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2013-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2013-04-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2013-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2013-04-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2013-01-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2013-04-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2013-01-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-10-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2013-01-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-10-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-07-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2012-10-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-04-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2012-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-04-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-01-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2012-04-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2012-01-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-10-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2012-01-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-10-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-07-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2011-10-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-04-01'.to_date)
      ...
      Person_quarter.create_quarter_record(row.user_id, '2011-07-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-04-01'.to_date)
      Person_quarter.create_quarter_record(row.user_id, '2011-01-01'.to_date)
