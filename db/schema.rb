...
ActiveRecord::Schema.define(:version => 20130827164644) do
  ...
  add_index "of_commentmeta", ["comment_id"], :name => "comment_id"
  add_index "of_commentmeta", ["meta_key"], :name => "meta_key"
  ...
  add_index "of_comments", ["comment_approved", "comment_date_gmt"], :name => "comment_approved_date_gmt"
  add_index "of_comments", ["comment_date_gmt"], :name => "comment_date_gmt"
  add_index "of_comments", ["comment_parent"], :name => "comment_parent"
  add_index "of_comments", ["comment_post_ID"], :name => "comment_post_ID"
  ...
  add_index "of_links", ["link_visible"], :name => "link_visible"
  ...
  add_index "of_of_badge_lib", ["id"], :name => "id", :unique => true
  ...
  add_index "of_of_goal_lib", ["id"], :name => "id", :unique => true
  ...
  add_index "of_of_measurements", ["date", "device_serial", "user_id"], :name => "unique_measure", :unique => true, :length => {"date"=>nil, "device_serial"=>20, "user_id"=>nil}
  add_index "of_of_measurements", ["id"], :name => "id", :unique => true
  add_index "of_of_measurements", ["user_id"], :name => "user_id"
  ...
  add_index "of_of_oauth_request", ["request_key"], :name => "request_key"
  ...
  add_index "of_of_sharing", ["fb_id"], :name => "fb_id", :unique => true
  add_index "of_of_sharing", ["id"], :name => "id", :unique => true
  ...
  add_index "of_of_user_badges", ["id"], :name => "id", :unique => true
  add_index "of_of_user_badges", ["user_id"], :name => "user_id"
  ...
  add_index "of_of_user_goals", ["id"], :name => "id", :unique => true
  add_index "of_of_user_goals", ["user_id", "goal_id"], :name => "user_goal", :unique => true
  add_index "of_of_user_goals", ["user_id"], :name => "user_id"
  ...
  add_index "of_of_users", ["facebook_user_id"], :name => "facebook_user_id", :unique => true
  add_index "of_of_users", ["twitter_user_id"], :name => "twitter_user_id", :unique => true
  add_index "of_of_users", ["user_id"], :name => "id", :unique => true
  ...
  add_index "of_options", ["option_name"], :name => "option_name", :unique => true
  ...
  add_index "of_postmeta", ["meta_key"], :name => "meta_key"
  add_index "of_postmeta", ["post_id"], :name => "post_id"
  ...
  add_index "of_posts", ["post_author"], :name => "post_author"
  add_index "of_posts", ["post_name"], :name => "post_name"
  add_index "of_posts", ["post_parent"], :name => "post_parent"
  add_index "of_posts", ["post_type", "post_status", "post_date", "ID"], :name => "type_status_date"
  ...
  add_index "of_rg_form_view", ["form_id"], :name => "form_id"
  ...
  add_index "of_rg_lead", ["form_id"], :name => "form_id"
  add_index "of_rg_lead", ["status"], :name => "status"
  ...
  add_index "of_rg_lead_detail", ["form_id"], :name => "form_id"
  add_index "of_rg_lead_detail", ["lead_id"], :name => "lead_id"
  ...
  add_index "of_rg_lead_meta", ["lead_id"], :name => "lead_id"
  add_index "of_rg_lead_meta", ["meta_key"], :name => "meta_key"
  ...
  add_index "of_rg_lead_notes", ["lead_id", "user_id"], :name => "lead_user_key"
  add_index "of_rg_lead_notes", ["lead_id"], :name => "lead_id"
  ...
  add_index "of_rg_mailchimp", ["form_id"], :name => "form_id"
  ...
  add_index "of_term_relationships", ["term_taxonomy_id"], :name => "term_taxonomy_id"
  ...
  add_index "of_term_taxonomy", ["taxonomy"], :name => "taxonomy"
  add_index "of_term_taxonomy", ["term_id", "taxonomy"], :name => "term_id_taxonomy", :unique => true
  ...
  add_index "of_terms", ["name"], :name => "name"
  add_index "of_terms", ["slug"], :name => "slug", :unique => true
  ...
  add_index "of_usermeta", ["meta_key"], :name => "meta_key"
  add_index "of_usermeta", ["user_id"], :name => "user_id"
  ...
  add_index "of_users", ["user_login"], :name => "user_login_key"
  add_index "of_users", ["user_nicename"], :name => "user_nicename"
